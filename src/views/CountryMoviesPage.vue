    ...
    <section>
      <div class="container bv-example-row">
        ...
        <div class=" pt-5 mb-3 d-flex">
          <h4 class="title">{{ $t('title.countries.' + country) }}</h4>
        </div>
  ...
  data() {
    return {
      ...
      smallMovieCards: [
        {
          slug: 'Joker',
          thumbnail: 'https://www.uptvs.com/wp-contents/uploads/2022/12/joker-2-jadval.jpg',
          link: 'thumbnail',
          title: 'فیلم جوکر 2 Joker 2 2023',
          hasTag: true,
          tag: {
            title: 'امروز',
            color: 'white'
      ...
      comingSoonMovieSmallCards: [
        {
          slug: 'Twisters',
          thumbnail: 'https://www.uptvs.com/wp-contents/uploads/2024/03/twin-3.jpg',
          link: 'thumbnail',
          title: 'فیلم گردبادها Twisters 2024 ',
          hasTag: true,
          tag: {
            title: '  119 روز مانده ',
            color: 'white'
