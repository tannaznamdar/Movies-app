          ...
          <div class="col-lg-3 col-md-12">
            ...
            <section class="update-series mb-40">
              ...
              <div class="row flex-direction">
                <div class="col-lg-12 col-md-6" v-for="smallSerialCard in smallSerialCards">
            ...
            <section class="update-series">
              ...
              <div class="row flex-direction">
                <div class="col-lg-12 col-md-6" v-for="comingSoonSerialSmallCard in comingSoonSerialSmallCards">
