                    ...
                    <div class="col-lg-3">
                            ...
                            <div class="main-sidebar-wrap">
                                    ...
                                    <div class="col-lg-4">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <defs>
                                                ...
                                                <filter id="b" x="0" y="0" width="90" height="90"
                                                ...
                                                <linearGradient id="d" x1="0.5" x2="0.5" y2="1"
                                                    gradientUnits="objectBoundingBox">
                                            ...
                                            <g transform="translate(-519.5 -1013.5)">
                                                <circle cx="29.5" cy="29.5" r="29.5" transform="translate(535 1027)"
                                                    opacity="0.1" fill="url(#a)"></circle>
                                                <g transform="matrix(1, 0, 0, 1, 519.5, 1013.5)" filter="url(#b)">
                                                    <circle cx="22.5" cy="22.5" r="22.5"
                                                        transform="translate(22.5 20.5)" fill="#fff"></circle>
                                                </g>
                                ...
                                <div>
                                    ...
                                    <button class="button button-lg button-lg--sidebar">
                                        <router-link class="active"
                                            :to='{ name: "persianDubPageRoute", params: { slug: "movies" } }'>فیلم
                                            های دوبله فارسی
                                        </router-link>
                                    </button>
                                </div>
                        ...
                        <section class="update-series">
                            <div class="mb-4 d-flex align-items-center justify-content-between">
                                ...
                                <button class="button button--transparent">
                                    <router-link class="active"
                                        :to='{ name: "otherPageRoute", params: { content: "ComingSoon" } }'>
                                        مشاهده
                                        همه </router-link>
                                </button>
                            </div>
