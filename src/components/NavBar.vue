...
export default {
  ...
  methods: {
    checkRouteName(location) {
      ...
      if (location.name === 'editProfilePageRoute') {
        return false
      }
      ...
      if (location.name === 'ticketsChatPageRoute') {
        return false
      }
      ...
      if (location.name === 'faqPageRoute') {
        return false
      }
      if (location.name === 'listsPageRoute') {
        return false
      }
      if (location.name === 'editListPageRoute') {
        return false
      }
